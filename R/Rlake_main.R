...
ptm <- proc.time()
mstart<-chron::chron(M_start, origin=c(month = 12, day = 31, year =1999))
mstop<-chron::chron(M_stop, origin=c(month = 12, day = 31, year =1999))

d1<-which(tt==M_start)
d2<-which(tt==M_stop)
tt<-chron::chron(tt[d1:d2], origin=c(month = 12, day = 31, year =1999))# transform into chron format
